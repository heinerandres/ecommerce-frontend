  ...
  return (
    <nav className="max-w-screen h-[10vh] bg-white border-b border-gray-200 shadow-lg z-20">
        ...
        <div className="flex items-center justify-around h-full">
            <Link href='/'><img className="h-full w-[10vw]" src="/next.svg" /></Link>
            <div className="flex h-[45%] ml-[2%]">
              <select className="text-black bg-gray-200 rounded-l-lg px-[1%]">
                <option>Todas las Categorías</option>
                <option>Camisetas</option>
                <option>Pantalonetas</option>
                <option>Pijamas</option>
              </select>
              <input type="text" className="w-[40vw] border border-gray-300"></input>
            ...
            <div className="flex items-center w-[20vw]">
              ...
              <Identificate />
              <Link href="/pedidos" className="flex items-center font-bold px-[4%] cursor-pointer"><i className="fa fa-gift mr-[5%]"></i>Pedidos</Link>
              <NavCart />
              <LogOut />
            </div>
        </div>
