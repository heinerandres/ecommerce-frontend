...
import { ColoresColumns } from "./ColoresColumns";

type Props = {
    colores: {_id: string, nombre: string,  valor:string, cantidadProductos:number}[]  | null;
}

export default function TablaColores({colores}: Props) {
